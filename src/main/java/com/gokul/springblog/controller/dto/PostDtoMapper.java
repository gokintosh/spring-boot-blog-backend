package com.gokul.springblog.controller.dto;
...
public class PostDtoMapper {
    ...
    private static PostDto mapToPostDto(Post post) {
        return PostDto.builder().id(post.getId()).title(post.getTitle()).content(post.getContent()).created(post.getCreated()).build();
    }
}
